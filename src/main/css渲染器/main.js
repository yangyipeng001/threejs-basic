...
function init() {
  ...
  const earthMaterial = new THREE.MeshPhongMaterial({
    specular: 0x333333,
    shininess: 5,
    map: textureLoader.load("textures/textures/planets/earth_atmos_2048.jpg"),
    specularMap: textureLoader.load("textures/textures/planets/earth_specular_2048.jpg"),
    normalMap: textureLoader.load("textures/textures/planets/earth_normal_2048.jpg"),
  ...
  const moonMaterial = new THREE.MeshPhongMaterial({
    shininess: 5,
    map: textureLoader.load("textures/textures/planets/moon_1024.jpg"),
  });
...
function animate() {
  ...
  // project: 将此向量(坐标)从世界空间投影到相机的标准化设备坐标 (NDC) 空间
